...
set_property -name {xsim.simulate.saif} -value {testB2_..saif} -objects [current_fileset -simset]
...
read_saif {/curr/peipei/PhD/EnergyPipeline/0benchSuite/FPGA16/testBroadcast_sweep/testBroadcast_cpy/solution1/impl/ip/tmp.sim/sim_1/behav/testB2_..saif}
report_power -hier all -l 10000000 -verbose -file {/curr/peipei/xilinx/testB2_..pwr} -xpe {/curr/peipei/xilinx/testB2_..xpe} -name {testB2_.}
#%29 nets 

set_property -name {xsim.simulate.saif} -value {testB2_._impl.saif} -objects [current_fileset -simset]
launch_simulation -mode post-implementation -type timing


#source apatb_mm_top.tcl
set_load 0 [all_outputs]
read_saif {/curr/peipei/PhD/EnergyPipeline/0benchSuite/FPGA16/testBroadcast_sweep/testBroadcast_cpy/solution1/impl/ip/tmp.sim/sim_1/impl/timing/testB2_._impl.saif}
report_power -hier all -l 10000000 -verbose -file {/curr/peipei/xilinx/testB2_._impl.pwr} -xpe {/curr/peipei/xilinx/testB2_._impl.xpe} -name {testB2_._impl}
