...
open_project testFolder/solution1/impl/ip/tmp.xpr
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1

add_files -norecurse -scan_for_includes testFolder/solution1/impl/verilog
import_files -norecurse testFolder/solution1/impl/verilog
update_compile_order -fileset sources_1
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
update_compile_order -fileset sources_1
...
#add xdc
add_files -fileset constrs_1 -norecurse testFolder/solution1/impl/verilog/mm.xdc
import_files -fileset constrs_1 testFolder/solution1/impl/verilog/mm.xdc

#add sim_files
set_property SOURCE_SET sources_1 [get_filesets sim_1]

add_files -fileset sim_1 -norecurse -scan_for_includes testFolder/solution1/sim/verilog
import_files -fileset sim_1 -norecurse testFolder/solution1/sim/verilog
...
read_saif {testFolder/solution1/impl/ip/tmp.sim/sim_1/behav/testFlow.saif}
...
set_load 0 [all_outputs]
read_saif {testFolder/solution1/impl/ip/tmp.sim/sim_1/impl/timing/testFlow_impl.saif}
